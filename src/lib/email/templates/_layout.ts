      ...
      <table width="100%" cellpadding="0" cellspacing="0" role="presentation" class="ec"
        ...
        <tr>
          <td align="center" bgcolor="${c.headerFrom}"
            ...
            <span style="display:block;font-size:34px;font-family:${serif};font-weight:600 !important;font-style:italic;color:${c.white} !important;letter-spacing:0.05em;line-height:1;text-shadow:0 2px 8px rgba(0,0,0,0.6) !important;-webkit-text-stroke:0.3px ${c.white}">Voem.</span>
            <span style="display:block;margin-top:8px;font-size:11px;font-family:${sans};font-weight:500 !important;color:rgba(255,255,255,0.85) !important;letter-spacing:0.14em;text-transform:uppercase">Convites de casamento</span>
          </td>
        </tr>
