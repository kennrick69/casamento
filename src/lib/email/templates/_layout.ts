      ...
      <table width="100%" cellpadding="0" cellspacing="0" role="presentation" class="ec"
        ...
        <tr>
          <td align="center" bgcolor="${c.headerFrom}"
            ...
            <span style="display:block;font-size:34px;font-family:${serif};font-weight:normal;font-style:italic;color:${c.white};letter-spacing:0.05em;line-height:1">Voem.</span>
